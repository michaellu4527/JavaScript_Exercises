...
'This is also a string';	//Can use single OR double quotes for strings
...
"This is Joe's \"favorite\" string";	//Use backslash to bypass ending string. Need to use for each occurence
